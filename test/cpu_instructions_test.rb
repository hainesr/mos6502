...
class Mos6502::CpuInstructionsTest < Minitest::Test
  ...
  def test_0x16
    @cpu.load!([0xa9, 0x7f, 0xa2, 0xbc, 0x95, 0x70, 0x16, 0x70])
    @cpu.step
    @cpu.step
    @cpu.step
    @cpu.step
  ...
  def test_0x1e
    @cpu.load!([0xa9, 0x7f, 0xa2, 0x10, 0x9d, 0x0f, 0x70, 0x1e, 0x0f, 0x70])
    @cpu.step
    @cpu.step
    @cpu.step
    @cpu.step
    ...
    assert(@cpu.negative?)
    refute(@cpu.zero?)
    assert_equal([0xfe], @cpu.dump_memory(0x701f, 1))
  end
  ...
  def test_0x3e
    @cpu.load!([0xa9, 0x7f, 0xa2, 0x10, 0x9d, 0x0f, 0x70, 0x3e, 0x0f, 0x70])
    @cpu.step
    @cpu.step
    @cpu.step
    @cpu.step
  ...
  def test_0x56
    @cpu.load!([0xa9, 0x7f, 0xa2, 0xbc, 0x95, 0x70, 0x56, 0x70])
    @cpu.step
    @cpu.step
    @cpu.step
    @cpu.step
  ...
  def test_0x5e
    @cpu.load!([0xa9, 0x7f, 0xa2, 0x10, 0x9d, 0x0f, 0x70, 0x5e, 0x0f, 0x70])
    @cpu.step
    @cpu.step
    @cpu.step
    @cpu.step
  ...
  def test_0x6e
    @cpu.load!([0xa9, 0x7f, 0x8d, 0x0f, 0x70, 0x6e, 0x0f, 0x70])
    @cpu.step
    @cpu.step
    @cpu.step
    assert(@cpu.carry?)
  ...
  def test_0xc6
    @cpu.load!([0xa9, 0x01, 0x85, 0x92, 0xc6, 0x92, 0xc6, 0x92])
    @cpu.step
    @cpu.step
    assert_equal([0x01], @cpu.dump_memory(0x92, 1))
    refute(@cpu.negative?)
    refute(@cpu.zero?)
    @cpu.step
    assert_equal([0x00], @cpu.dump_memory(0x92, 1))
    refute(@cpu.negative?)
    assert(@cpu.zero?)
    @cpu.step
    assert_equal([0xff], @cpu.dump_memory(0x92, 1))
    assert(@cpu.negative?)
    refute(@cpu.zero?)
  end
  ...
  def test_0xce
    @cpu.load!(
      [0xa9, 0x01, 0x8d, 0x92, 0x53, 0xce, 0x92, 0x53, 0xce, 0x92, 0x53]
    )
    @cpu.step
    @cpu.step
    assert_equal([0x01], @cpu.dump_memory(0x5392, 1))
    refute(@cpu.negative?)
    refute(@cpu.zero?)
    @cpu.step
    assert_equal([0x00], @cpu.dump_memory(0x5392, 1))
    refute(@cpu.negative?)
    assert(@cpu.zero?)
    @cpu.step
    assert_equal([0xff], @cpu.dump_memory(0x5392, 1))
    assert(@cpu.negative?)
    refute(@cpu.zero?)
  end
  ...
  def test_0xd6
    @cpu.load!([0xa9, 0x01, 0xa2, 0x08, 0x95, 0x92, 0xd6, 0x92, 0xd6, 0x92])
    @cpu.step
    @cpu.step
    @cpu.step
    assert_equal([0x01], @cpu.dump_memory(0x9a, 1))
    @cpu.step
    assert_equal([0x00], @cpu.dump_memory(0x9a, 1))
    refute(@cpu.negative?)
    assert(@cpu.zero?)
    @cpu.step
    assert_equal([0xff], @cpu.dump_memory(0x9a, 1))
    assert(@cpu.negative?)
    refute(@cpu.zero?)
  end
  ...
  def test_0xe6
    @cpu.load!([0xa9, 0xfe, 0x85, 0x92, 0xe6, 0x92, 0xe6, 0x92])
    @cpu.step
    @cpu.step
    assert_equal([0xfe], @cpu.dump_memory(0x92, 1))
    assert(@cpu.negative?)
    refute(@cpu.zero?)
    @cpu.step
    assert_equal([0xff], @cpu.dump_memory(0x92, 1))
  ...
  def test_0xee
    @cpu.load!(
      [0xa9, 0xfe, 0x8d, 0x92, 0x32, 0xee, 0x92, 0x32, 0xee, 0x92, 0x32]
    )
    @cpu.step
    @cpu.step
    assert_equal([0xfe], @cpu.dump_memory(0x3292, 1))
    assert(@cpu.negative?)
    refute(@cpu.zero?)
    @cpu.step
    assert_equal([0xff], @cpu.dump_memory(0x3292, 1))
    assert(@cpu.negative?)
    refute(@cpu.zero?)
    @cpu.step
    assert_equal([0x00], @cpu.dump_memory(0x3292, 1))
    refute(@cpu.negative?)
    assert(@cpu.zero?)
  end
  ...
  def test_0xf6
    @cpu.load!([0xa9, 0xfe, 0xa2, 0x08, 0x95, 0x92, 0xf6, 0x92, 0xf6, 0x92])
    @cpu.step
    @cpu.step
    @cpu.step
    assert_equal([0xfe], @cpu.dump_memory(0x9a, 1))
    @cpu.step
    assert_equal([0xff], @cpu.dump_memory(0x9a, 1))
    assert(@cpu.negative?)
    refute(@cpu.zero?)
