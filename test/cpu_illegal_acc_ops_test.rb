...
class Mos6502::CpuIllegalAccumulatorOperationsTest < Minitest::Test
  def test_zero_page
    ...
    [
      ...
      [0x67, 0xf3, 0x40, true, false, false, false], # RRA
  ...
  def test_zero_page_x
    ...
    [
      ...
      [0x77, 0x0d, 0x59, false, false, true, false], # RRA
  ...
  def test_absolute
    ...
    [
      ...
      [0x6f, 0x99, 0x66, true, false, false, true],   # RRA
  ...
  def test_absolute_y
    ...
    [
      ...
      [0x7b, 0x9a, 0x66, true, false, false, true],   # RRA
  ...
  def test_indexed_indirect
    ...
    [
      ...
      [0x63, 0x99, 0x59, true, false, false, true],  # RRA
  ...
  def test_indirect_indexed
    ...
    [
      ...
      [0x73, 0x8f, 0x50, true, false, false, true],   # RRA
